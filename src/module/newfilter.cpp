...
Mat JointWMF::filter(Mat &I, Mat &feature, int r, float sigma, int nI, int nF, int iter, string weightType, Mat mask)
{
...
Mat JointWMF::filterCore(Mat &I, Mat &F, float **wMap, int r, int nF, int nI, Mat mask)
{
...
/***************************************************************/
inline void JointWMF::updateBCB(int &num, int *f, int *b, int i, int v)
{
...
/***************************************************************/
float **JointWMF::float2D(int dim1, int dim2)
{
...
/***************************************************************/
void JointWMF::float2D_release(float **p)
{
    delete[] p[0];
    delete[] p;
}
...
/***************************************************************/
int **JointWMF::int2D(int dim1, int dim2)
{
...
/***************************************************************/
void JointWMF::int2D_release(int **p)
{
    delete[] p[0];
    delete[] p;
}
...
/***************************************************************/
void JointWMF::featureIndexing(Mat &F, float **&wMap, int &nF, float sigmaI, string weightType)
{
...
/***************************************************************/
void JointWMF::from32FTo32S(Mat &img, Mat &outImg, int nI, float *mapping)
{
...
/***************************************************************/
void JointWMF::from32STo32F(Mat &img, Mat &outImg, float *mapping)
{
